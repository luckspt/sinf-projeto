...
public class myCloud {
    ...
    private static void verifySignature(File file, ByteArrayOutputStream signatureStream, BufferedInputStream fileBufferedInputStream) throws KeyStoreException, IOException, InvalidKeyException, NoSuchAlgorithmException, SignatureException {
...
//        if(signature.verify(fileStream.toByteArray(), new ByteArrayInputStream(signatureStream.toByteArray()), certificate))
        if(signature.verify(signatureStream.toByteArray(), fileBufferedInputStream, certificate))
